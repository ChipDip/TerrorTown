...
if SERVER then
   resource.AddFile("materials/VGUI/ttt/icon_gearsgaming.com_barret.vmt")
   resource.AddFile("models/weapons/gearsgaming.com/barret/v_snip_awp.mdl")
   resource.AddFile("models/weapons/gearsgaming.com/barret/w_snip_awp.mdl")
end
